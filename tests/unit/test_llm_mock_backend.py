...
from intentos.llm.backends.base import Message, LLMRole, ToolDefinition, LLMUsage
...
class TestMockBackendIntegration:
    ...
    def test_usage_estimation_accuracy(self):
        ...
        long_usage = backend._estimate_usage([long_msg], "This is a longer response with more content")
