...
from intentos.semantic_vm import SemanticInstruction, SemanticOpcode
from intentos.semantic_vm.gas import ExecutionBudget, GasCosts, GasReceipt
...
class TestGasManager:
    ...
    def test_consume_gas_with_extra(self):
        ...
        success, cost = manager.consume_gas(budget, SemanticOpcode.LOOP, extra_gas=50)
    ...
    def test_full_program_estimation(self):
        ...
        instructions = [
            ...
            SemanticInstruction(
                ...
                body=[
                    SemanticInstruction(
                        opcode=SemanticOpcode.SET, parameters={"name": "x", "value": "x+1"}
                    ),
                ],
            ),
