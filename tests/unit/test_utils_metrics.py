...
class TestMetricSample:
    ...
    def test_create_sample(self):
        ...
        sample = MetricSample(
            name="test_metric", value=42.0, labels=[MetricLabel(name="tag", value="value")]
        )
...
class TestMetricRegistry:
    ...
    def test_register_histogram_custom_buckets(self):
        ...
        histogram = test_registry.histogram("test", buckets=(0.1, 0.5, 1.0))
...
class TestSpan:
    ...
    def test_span_with_attributes(self):
        """带属性的 Span"""
        span = Span(name="test", start_time=time.time(), attributes={"key": "value", "count": 42})
