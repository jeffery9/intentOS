...
from intentos.compiler.compiler import IntentCompiler, CompiledPrompt
from intentos.core import Intent, IntentType, Context
...
async def demo_context_management():
    ...
    print(f"  已添加：conversation_history")
    ...
    print(f"  已添加：temporary_data (低重要性)")
