...
class TransactionManager:
    ...
    def get_transaction(self, tx_id: str) -> Optional[Transaction]:
        """获取事务"""
        return self._active_transactions.get(tx_id) or self._committed_transactions.get(tx_id)
...
class TransactionalMemory:
    ...
    def commit(self) -> bool:
        ...
        success = TransactionManager().commit_transaction(self._current_transaction, self._memory)
    ...
    def rollback(self) -> bool:
        ...
        success = TransactionManager().rollback_transaction(self._current_transaction, self._memory)
